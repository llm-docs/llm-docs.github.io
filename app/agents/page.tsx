  ...
  return (
    <section className="space-y-8 px-6 pb-16 xl:px-0">
      <header className="space-y-3">
        ...
        <h1 className="text-4xl font-semibold tracking-tight text-slate-950">Agent framework directory</h1>
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        {agents.map((agent) => (
          <Link key={agent.slug} href={`/agents/${agent.slug}`} className="surface-card group space-y-3 transition hover:-translate-y-0.5 hover:border-slate-300">
