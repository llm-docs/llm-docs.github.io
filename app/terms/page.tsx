export const metadata = {
  title: "Terms of Use",
  description: "Terms of use for LLM-Docs.",
};
    ...
    <article className="space-y-8 px-6 pb-16 xl:px-0">
      <header className="space-y-3">
        ...
        <p className="max-w-3xl text-lg leading-8 text-slate-300">
          By using LLM-Docs, you agree to use the website for lawful informational and research purposes only.
        </p>
      </header>
      ...
      <section className="surface-card space-y-4 text-sm leading-7 text-slate-300">
        ...
        <p>LLM-Docs does not guarantee completeness, accuracy, or suitability for any particular commercial, legal, financial, or technical decision.</p>
      </section>
    </article>
  );
}
